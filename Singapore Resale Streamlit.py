...
st.title(":green[Singapore Resale] :green[Flat Prices] :green[Prediction]")
...
test_data =[[date.month, data['town'][town], data['flat_type'][flat_type], data['block'][block], data['street_name'][street_name],
                     ...
                     data['remaining_lease'][remaining_lease], date.year, int(float(storey[0])), float(storey[0]),is_remaining_lease, 
